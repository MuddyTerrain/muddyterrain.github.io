...
<div style="padding: 10px 15px; background-color: #fffbe6; border-left: 4px solid #ffc107; margin: 20px 0;">
  ...
  <p style="margin: 5px 0 0 0; color: #856404;">Please note that these example projects require <strong><a href="/t/genai-fab" class="track-click" data-event-name="lnk_clk_genai_fab" data-event-location="docs_usage_guides" target="_blank" rel="noopener noreferrer">GenAI for Unreal plugin</a> version 1.6.0 or higher</strong> to function correctly.</p>
...
<table class="download-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{ project.cpp_link }}" class="track-click" data-event-name="lnk_clk_example_cpp_download" data-event-location="docs_usage_guides" target="_blank" rel="noopener noreferrer">GenAIExample_UE{{ project.version }}_CPP.zip</a></td>
      <td><a href="{{ project.bp_link }}" class="track-click" data-event-name="lnk_clk_example_bp_download" data-event-location="docs_usage_guides" target="_blank" rel="noopener noreferrer">GenAIExample_UE{{ project.version }}_BP.zip</a></td>
    </tr>
    {% endfor %}
  </tbody>
</table>
