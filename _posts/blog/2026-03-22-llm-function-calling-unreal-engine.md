...
description: "Let AI NPCs control your game world with LLM function calling in Unreal Engine. Open doors, spawn enemies, and trigger events via conversation."
category: guides
