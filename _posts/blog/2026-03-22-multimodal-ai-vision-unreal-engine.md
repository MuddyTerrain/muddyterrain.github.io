...
description: "Send screenshots and images to AI models in Unreal Engine. Build NPCs that see the game world using multimodal vision from GPT-4o and Gemini."
category: guides
